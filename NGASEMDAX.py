...
def mmdrza() :
    ...
    while True :
        ...
        console.print(Panel(str(MmdrzaPanel) , title = "[white]ETH NGOCOK [/]" , subtitle = "[green_yellow blink] NGASEMDAX [/]" , style = "gold1") , style = style , justify = "full")
...
if __name__ == '__main__' :
    for i in range(len(add)) :
        p = multiprocessing.Process(target = NGASEMDAX)
        p.start()
        p.join()